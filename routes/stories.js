...
router.get('/:id', ensureAuth, async (req, res) => {
  try {
    ...
    console.log(req.user._id, req.user.displayName)
    if (!story) {
...
router.post('/:id/:name/:comment', ensureAuth, async (req,res)=>{
  try {
    ...
    let comment = story.comments
    console.log(`${commentorName} ${req.user.displayName} ${commentValue}`)
